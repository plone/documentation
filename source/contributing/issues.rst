...
.. note::
   ...
   style-guides for `documentation <https://docs.plone.org/about/contributing/index.html>`_ and :doc:`reStructuredText [reST]<style-guide>`.

.. todo::

   Fix above to internal links to documents
