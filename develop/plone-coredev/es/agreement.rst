...
* Asistir una `conferencia <https://plone.org/events/conferences>`_ / un `simposio <https://plone.org/events/regional>`_ o participar en un `sprints <https://plone.org/events/sprints>`_ / `tune-ups <https://plone.org/events/plone-tuneups>`_. Hay abundancia de oportunidades de conocer la comunidad y comenzar a contribuir a través de varias sesiones de programación, ya sea en persona o en la web. Usted puede incluso ser capaz de obtener acceso inmediato en una conferencia si usted ha demostrando sus habilidades de programación y las personas adecuada asisten.
