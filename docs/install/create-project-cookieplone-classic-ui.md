...
myst:
  html_meta:
    "description": "Install Plone via Cookieplone for Classic UI only"
    "property=og:description": "Install Plone via Cookieplone for Classic UI only"
    "property=og:title": "Install Plone via Cookieplone for Classic UI only"
...
# Install Plone via Cookieplone for Classic UI only

This chapter describes how you can create a web application using the {term}`Cookieplone` template with Classic UI for the frontend.
