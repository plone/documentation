...
myst:
  html_meta:
    "description": "How does GenericSetup work"
    "property=og:description": "How does GenericSetup work"
    "property=og:title": "GenericSetup"
    "keywords": "Plone 6, backend, GenericSetup"
---
...
See {ref}`genericsetup-generic-setup-files-label` for a list.
```
...
<genericsetup:upgradeDepends
    ...
    destination="4000"
    profile="your.addonpackage:default"
    title="Apply registry.xml from the profile 'to_1002'"
    import_profile="your.addonpackage:to_1002"
