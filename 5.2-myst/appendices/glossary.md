...
: The standard plaintext markup language used for Python
  ...
  [reStructuredText](http://docutils.sourceforge.net/rst.html) is an
  ...
  reStructuredText is a revision and reinterpretation of the {term}`StructuredText` and [Setext](http://docutils.sourceforge.net/mirror/setext.html) lightweight markup systems.
...
: A Zope technology that supports virtual hosting. See
  [VirtualHostMonster URL rewriting mechanism](http://docs.zope.org/zope2/zope2book/VirtualHosting.html)
...
: Cascading Style Sheets is a way to separate content from
  ...
  [documented at the W3C web site](http://www.w3.org/Style/CSS/). If
  you want to learn CSS, we recommend [the W3Schools CSS Resources](http://www.w3schools.com/Css/default.asp)
  and the [SitePoint CSS Reference](http://reference.sitepoint.com/css).
...
: Simply put, any Zope object can acquire any object or property from
  ...
  *A*, where it's found. The reality, inevitably, is more complex than
  ...
  Book](https://zope.readthedocs.io/en/latest/zope2book/Acquisition.html).
...
: *PLone Improvement Proposal* (just like Python's PEPs: Python
  ...
  [Framework Team](https://plone.org/team/FrameworkTeam), who reviews
  ...
  [PLIP](https://dev.plone.org/plone/wiki/PLIP).
...
: ZEO (Zope Enterprise Objects) is a scaling solution used with Zope.
  ...
  info, see [the related chapter in The Zope Book](http://docs.zope.org/zope2/zope2book/ZEO.html).
...
: Publishing an object from the ZODB by traversing its parent objects,
  ...
  in the Zope 2 book](http://docs.zope.org/zope2/zope2book/ZEO.html).
...
: The Zope Component Architecture (ZCA) is a Python framework for
  ...
  From [A Comprehensive Guide to Zope Component Architecture](http://www.muthukadan.net/docs/zca.html).
...
: Buildout is a Python-based build system for creating, assembling and deploying applications from multiple parts, some of which may be non-Python-based. It lets you create a buildout configuration and reproduce the same software later. See [buildout.org](http://www.buildout.org/en/latest/)
