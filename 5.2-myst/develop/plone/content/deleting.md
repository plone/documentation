...
For more information check the documentation of [plone.app.linkintegrity](https://pypi.python.org/pypi/plone.app.linkintegrity/3.0).
...
[OFS.ObjectManager](http://svn.zope.org/Zope/trunk/src/OFS/ObjectManager.py?rev=115507&view=auto), the base class for Zope folders,
