...
Plone 5 has chosen to use the [Less CSS preprocessor](http://lesscss.org/) because it is compiled by JavaScript tools, which fit with the new Plone Resource Registry.
