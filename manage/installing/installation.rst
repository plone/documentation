...
See the `Windows-specific installation instructions <https://github.com/plone/Installers-UnifiedInstaller/blob/master/docs/windows.rst> that are included with the installer.
